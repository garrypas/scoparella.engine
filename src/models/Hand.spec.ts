...
describe("Hand tests", function () {
    ...
    describe("fromDtoArray/toDtoArray() serializes/deserializes the Hand array", () => {
        ...
        test("cards serialized/deserialized", () => {
            ...
            expect(ComparableArray.isSubset([ _card1, _card2 ], _handsAfter[0].cards)).toBeTruthy();
        ...
        test("captured serialized/deserialized", () => {
            ...
            expect(ComparableArray.hasItem(_card3, _handsAfter[0].captured)).toBeTruthy();

            expect(_handsAfter[1].captured).toHaveLength(2);
            expect(ComparableArray.isSubset([ _card5, _card6 ], _handsAfter[1].captured)).toBeTruthy();
        });
    ...
    describe("capture()", () => {
        ...
        test("captures many", () => {
            const hand = new Hand(_player1);
            hand.capture([ new Card(Face.Ace, Suit.Clubs), new Card(Face.Ace, Suit.Coins) ]);
